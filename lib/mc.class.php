...
/*
	...
	* Licence		: Do not use this without permission of author anywhere.
*/
class Mc
{
    private $num1;
    ...
    private function generate()
    {
        ...
        switch ($this->actionNumber)
        {
            ...
            case 3:
                $this->arr['question'] = $this->num1 . " &times " . $this->num2 . " = ? ";
...
//            session_start();
//        }
        return $_SESSION['mcData']['question'];
